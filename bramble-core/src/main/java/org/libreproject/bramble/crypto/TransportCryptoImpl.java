...
import org.libreproject.bramble.api.transport.OutgoingKeys;
...
import static org.libreproject.bramble.api.Bytes.compare;
import static org.libreproject.bramble.api.transport.TransportConstants.ALICE_HANDSHAKE_HEADER_LABEL;
import static org.libreproject.bramble.api.transport.TransportConstants.ALICE_HANDSHAKE_TAG_LABEL;
import static org.libreproject.bramble.api.transport.TransportConstants.ALICE_HEADER_LABEL;
import static org.libreproject.bramble.api.transport.TransportConstants.ALICE_TAG_LABEL;
import static org.libreproject.bramble.api.transport.TransportConstants.BOB_HANDSHAKE_HEADER_LABEL;
import static org.libreproject.bramble.api.transport.TransportConstants.BOB_HANDSHAKE_TAG_LABEL;
import static org.libreproject.bramble.api.transport.TransportConstants.BOB_HEADER_LABEL;
import static org.libreproject.bramble.api.transport.TransportConstants.BOB_TAG_LABEL;
import static org.libreproject.bramble.api.transport.TransportConstants.CONTACT_ROOT_KEY_LABEL;
import static org.libreproject.bramble.api.transport.TransportConstants.PENDING_CONTACT_ROOT_KEY_LABEL;
import static org.libreproject.bramble.api.transport.TransportConstants.ROTATE_LABEL;
import static org.libreproject.bramble.api.transport.TransportConstants.STATIC_MASTER_KEY_LABEL;
import static org.libreproject.bramble.api.transport.TransportConstants.TAG_LENGTH;
import static org.libreproject.bramble.util.ByteUtils.INT_16_BYTES;
import static org.libreproject.bramble.util.ByteUtils.INT_64_BYTES;
import static org.libreproject.bramble.util.ByteUtils.MAX_16_BIT_UNSIGNED;
import static org.libreproject.bramble.util.ByteUtils.MAX_32_BIT_UNSIGNED;
import static org.libreproject.bramble.util.ByteUtils.writeUint16;
import static org.libreproject.bramble.util.ByteUtils.writeUint64;
