...
import org.libreproject.bramble.api.Multiset;
...
import org.libreproject.bramble.api.keyagreement.event.KeyAgreementStoppedListeningEvent;
...
import org.libreproject.bramble.api.properties.event.RemoteTransportPropertiesUpdatedEvent;
...
import static org.libreproject.bramble.api.keyagreement.KeyAgreementConstants.TRANSPORT_ID_BLUETOOTH;
import static org.libreproject.bramble.api.plugin.BluetoothConstants.DEFAULT_PREF_ADDRESS_IS_REFLECTED;
import static org.libreproject.bramble.api.plugin.BluetoothConstants.DEFAULT_PREF_EVER_CONNECTED;
import static org.libreproject.bramble.api.plugin.BluetoothConstants.DEFAULT_PREF_PLUGIN_ENABLE;
import static org.libreproject.bramble.api.plugin.BluetoothConstants.ID;
import static org.libreproject.bramble.api.plugin.BluetoothConstants.PREF_ADDRESS_IS_REFLECTED;
import static org.libreproject.bramble.api.plugin.BluetoothConstants.PREF_EVER_CONNECTED;
import static org.libreproject.bramble.api.plugin.BluetoothConstants.PROP_ADDRESS;
import static org.libreproject.bramble.api.plugin.BluetoothConstants.PROP_UUID;
import static org.libreproject.bramble.api.plugin.BluetoothConstants.UUID_BYTES;
...
import static org.libreproject.bramble.api.properties.TransportPropertyConstants.REFLECTED_PROPERTY_PREFIX;
import static org.libreproject.bramble.util.LogUtils.logException;
import static org.libreproject.bramble.util.PrivacyUtils.scrubMacAddress;
import static org.libreproject.bramble.util.StringUtils.isNullOrEmpty;
import static org.libreproject.bramble.util.StringUtils.macToBytes;
import static org.libreproject.bramble.util.StringUtils.macToString;
