...
import static org.libreproject.bramble.api.keyagreement.KeyAgreementConstants.TRANSPORT_ID_LAN;
import static org.libreproject.bramble.api.plugin.LanTcpConstants.DEFAULT_PREF_PLUGIN_ENABLE;
import static org.libreproject.bramble.api.plugin.LanTcpConstants.ID;
import static org.libreproject.bramble.api.plugin.LanTcpConstants.PREF_IPV6;
import static org.libreproject.bramble.api.plugin.LanTcpConstants.PREF_LAN_IP_PORTS;
import static org.libreproject.bramble.api.plugin.LanTcpConstants.PROP_IPV6;
import static org.libreproject.bramble.api.plugin.LanTcpConstants.PROP_IP_PORTS;
import static org.libreproject.bramble.api.plugin.LanTcpConstants.PROP_PORT;
import static org.libreproject.bramble.api.properties.TransportPropertyConstants.MAX_PROPERTY_LENGTH;
...
import static org.libreproject.bramble.util.PrivacyUtils.scrubSocketAddress;
...
import static org.libreproject.bramble.util.StringUtils.toHexString;
