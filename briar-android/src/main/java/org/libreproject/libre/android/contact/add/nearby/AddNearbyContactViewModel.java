...
import org.libreproject.bramble.api.keyagreement.event.KeyAgreementAbortedEvent;
import org.libreproject.bramble.api.keyagreement.event.KeyAgreementFailedEvent;
import org.libreproject.bramble.api.keyagreement.event.KeyAgreementFinishedEvent;
import org.libreproject.bramble.api.keyagreement.event.KeyAgreementListeningEvent;
import org.libreproject.bramble.api.keyagreement.event.KeyAgreementStartedEvent;
import org.libreproject.bramble.api.keyagreement.event.KeyAgreementWaitingEvent;
...
import org.libreproject.bramble.plugin.bluetooth.BluetoothPlugin;
import org.libreproject.libre.R;
import org.libreproject.libre.android.contact.add.nearby.AddContactState.ContactExchangeFinished;
import org.libreproject.libre.android.contact.add.nearby.AddContactState.ContactExchangeResult.Error;
import org.libreproject.libre.android.contact.add.nearby.AddContactState.ContactExchangeResult.Success;
import org.libreproject.libre.android.contact.add.nearby.AddContactState.ContactExchangeStarted;
import org.libreproject.libre.android.contact.add.nearby.AddContactState.KeyAgreementListening;
import org.libreproject.libre.android.contact.add.nearby.AddContactState.KeyAgreementStarted;
import org.libreproject.libre.android.contact.add.nearby.AddContactState.KeyAgreementWaiting;
import org.libreproject.libre.android.qrcode.QrCodeDecoder;
import org.libreproject.libre.android.qrcode.QrCodeUtils;
...
import static org.libreproject.libre.android.contact.add.nearby.AddNearbyContactPermissionManager.areEssentialPermissionsGranted;
import static org.libreproject.libre.android.contact.add.nearby.AddNearbyContactViewModel.BluetoothDecision.NO_ADAPTER;
import static org.libreproject.libre.android.contact.add.nearby.AddNearbyContactViewModel.BluetoothDecision.REFUSED;
import static org.libreproject.libre.android.contact.add.nearby.AddNearbyContactViewModel.BluetoothDecision.UNKNOWN;
import static org.libreproject.libre.android.util.UiUtils.handleException;
import static org.libreproject.libre.android.util.UiUtils.isLocationEnabled;
